 ...
 * @param {object} entityTypeAndSlugToIdMapping - a mapping of entity type and slug to its numeric
...
/**
 * @param {object[]} createResourcePayloads
 * @param {_.Dictionary<[number, string]>} entityTypeAndSlugToIdMapping
 * @param {_.Dictionary<string>} lastIds
 * @param {boolean} mutableMapping
 */
function createResourcePayloadListToEntitiesAndRelationships(
  ...
  const nodesLabels = ['resource', 'entity']
  const relationshipsLabels = ['appears_in']
