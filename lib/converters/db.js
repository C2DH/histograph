...
const appearsInContextModifierDeserializer = (key, contextObject, separator) => {
  ...
  const reconstructedKey = key.split(separator).join('.')
  return set({}, reconstructedKey, context)
}

const toNeo4jResource = r => toNeo4jJson(r, { separators: ResourceSeparators })
const fromNeo4jResource = r => fromNeo4jJson(r, { separators: ResourceSeparators })
...
const toNeo4jChangeAction = r => toNeo4jJson(r,
  { modifiers: { meta__context: appearsInContextModifierSerializer } })
const fromNeo4jChangeAction = r => fromNeo4jJson(r,
  { modifiers: { meta__context: appearsInContextModifierDeserializer } })
