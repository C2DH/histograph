  ...
  return {
    ...
    */
    getCooccurrences: function (req, res) {
      ...
      if((form.params.entityA == 'person' || form.params.entityA == 'theme') 
        && form.params.entityA == form.params.entityB 
        && !form.params.from 
        && !form.params.to 
        && !form.params.with 
        && !form.params.without
        ...
        query = parser.agentBrown(
          form.params.entityA == form.params.entityB
          ? queries.get_cooccurrences
          : queries.get_bipartite_cooccurrences, 
          form.params
        )
      }
